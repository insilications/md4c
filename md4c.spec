...
Version  : 0.4.5
Release  : 8
URL      : file:///insilications/build/clearlinux/packages/md4c/md4c-release-0.4.5.tar.gz
Source0  : file:///insilications/build/clearlinux/packages/md4c/md4c-release-0.4.5.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1599712175
mkdir -p clr-build
pushd clr-build
